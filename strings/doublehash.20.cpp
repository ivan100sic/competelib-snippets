...
struct rolling_hash {
    ...
    strong_ordering operator<=> (const rolling_hash& b) const { return h() <=> b.h(); }
...
struct double_hash {
    ...
    strong_ordering operator<=> (const double_hash& b) const = default;
    bool operator== (const double_hash& b) const = default;
};
